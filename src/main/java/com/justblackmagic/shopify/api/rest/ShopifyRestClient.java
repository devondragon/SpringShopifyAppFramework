...
import com.justblackmagic.shopify.api.rest.exceptions.ShopifyClientException;
import com.justblackmagic.shopify.api.rest.exceptions.ShopifyErrorResponseException;
...
import com.justblackmagic.shopify.api.rest.model.Count;
import com.justblackmagic.shopify.api.rest.model.Image;
import com.justblackmagic.shopify.api.rest.model.ImageAltTextCreationRequest;
import com.justblackmagic.shopify.api.rest.model.Metafield;
import com.justblackmagic.shopify.api.rest.model.MetafieldRoot;
import com.justblackmagic.shopify.api.rest.model.MetafieldsRoot;
import com.justblackmagic.shopify.api.rest.model.Shop;
import com.justblackmagic.shopify.api.rest.model.ShopifyAccessTokenRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyCancelOrderRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomCollection;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomCollectionCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomCollectionRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomCollectionsRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomer;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomerRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomerUpdateRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomerUpdateRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyCustomersRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyFulfillment;
import com.justblackmagic.shopify.api.rest.model.ShopifyFulfillmentCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyFulfillmentRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyFulfillmentUpdateRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyGetCustomersRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyGiftCard;
import com.justblackmagic.shopify.api.rest.model.ShopifyGiftCardCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyGiftCardRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyImageRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyInventoryLevel;
import com.justblackmagic.shopify.api.rest.model.ShopifyInventoryLevelRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyLocation;
import com.justblackmagic.shopify.api.rest.model.ShopifyLocationsRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrder;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderRisk;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderRisksRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderShippingAddressUpdateRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrderUpdateRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyOrdersRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyPage;
import com.justblackmagic.shopify.api.rest.model.ShopifyProduct;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductMetafieldCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductUpdateRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyProducts;
import com.justblackmagic.shopify.api.rest.model.ShopifyProductsRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyRecurringApplicationCharge;
import com.justblackmagic.shopify.api.rest.model.ShopifyRecurringApplicationChargeCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyRecurringApplicationChargeRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyRefund;
import com.justblackmagic.shopify.api.rest.model.ShopifyRefundCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyRefundRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyShop;
import com.justblackmagic.shopify.api.rest.model.ShopifyTransaction;
import com.justblackmagic.shopify.api.rest.model.ShopifyTransactionsRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyVariant;
import com.justblackmagic.shopify.api.rest.model.ShopifyVariantMetafieldCreationRequest;
import com.justblackmagic.shopify.api.rest.model.ShopifyVariantRoot;
import com.justblackmagic.shopify.api.rest.model.ShopifyVariantUpdateRequest;
...
public class ShopifyRestClient {
	...
	private static final String MINIMUM_REQUEST_RETRY_DELAY_CANNOT_BE_LARGER_THAN_MAXIMUM_REQUEST_RETRY_DELAY_MESSAGE =
			"Maximum request retry delay must be larger than minimum request retry delay.";
	private static final String INVALID_MINIMUM_REQUEST_RETRY_DELAY_MESSAGE =
			"Minimum request retry delay cannot be set lower than 200 milliseconds.";



	private static final String HTTPS = "https://";
	private static final String API_TARGET = "/admin";
	...
	private static final String DEPRECATED_SHOPIFY_CALL_ERROR_MESSAGE =
			"Shopify call is deprecated. Please take note of the X-Shopify-API-Deprecated-Reason and correct the call.\nRequest Location of {}\nResponse Status Code of {}\nResponse Headers of:\n{}";
	static final String GENERAL_ACCESS_TOKEN_EXCEPTION_MESSAGE =
			"There was a problem generating access token using shop subdomain of %s and authorization code of %s.";
	...
	public static interface OptionalsStep {
		...
		/**
		 * The Shopify SDK uses random waits in between retry attempts. Minimum duration time to wait before retrying a failed request. Value must
		 * also be less than {@link #withMaximumRequestRetryRandomDelay(int, TimeUnit) Maximum Request Retry Random Delay}.<br>
		...
		/**
		 * The Shopify SDK uses random waits in between retry attempts. Maximum duration time to wait before retrying a failed request. Value must
		 * also be more than {@link #withMinimumRequestRetryRandomDelay(int, TimeUnit) Minimum Request Retry Random Delay}.<br>
		...
		/**
		 * String representation of the version you want to use. If not populated, this will use shopify oldest stable version. Although this is not
		 * recommended so you can target a set of shopify features. Ex: '2020-10' '2020-07' '2020-04'. If you are specifying the API URL ensure you
		 * leave off the version if you are using this.
		 *
		 * @param apiVersion
		 * @return
		 */
	...
	protected ShopifyRestClient(final Steps steps) {
		if (steps != null) {
	...
	protected static class Steps implements SubdomainStep, ClientSecretStep, AuthorizationTokenStep, AccessTokenStep, OptionalsStep {
		...
		@Override
		public ShopifyRestClient build() {
	...
	/**
	 * @param pageSize
	 * @return ShopifyPage<ShopifyProduct>
	 */
	...
	/**
	 * @param pageSize
	 * @return ShopifyPage<ShopifyCustomCollection>
	 */
	...
	public ShopifyPage<ShopifyCustomCollection> getCustomCollections(final String pageInfo, final int pageSize) {
		final Response response = get(
				getWebTarget().path(CUSTOM_COLLECTIONS).queryParam(LIMIT_QUERY_PARAMETER, pageSize).queryParam(PAGE_INFO_QUERY_PARAMETER, pageInfo));
		final ShopifyCustomCollectionsRoot shopifyCustomCollectionsRoot = response.readEntity(ShopifyCustomCollectionsRoot.class);
		return mapPagedResponse(shopifyCustomCollectionsRoot.getCustomCollections(), response);
	}
	...
	/**
	 * @return List<ShopifyCustomCollection>
	 */
	public List<ShopifyCustomCollection> getCustomCollections() {
		...
		log.info("Retrieved {} custom collections from first page", customCollectionsPage.size());
		shopifyCustomCollections.addAll(customCollectionsPage);

		while (customCollectionsPage.getNextPageInfo() != null) {
			customCollectionsPage = getCustomCollections(customCollectionsPage.getNextPageInfo(), DEFAULT_REQUEST_LIMIT);
			log.info("Retrieved {} custom collections from page info {}", customCollectionsPage.size(), customCollectionsPage.getNextPageInfo());
			shopifyCustomCollections.addAll(customCollectionsPage);
		}
	...
	/**
	 * @param shopifyCustomCollectionCreationRequest
	...
	/**
	 * @param shopifyProductCreationRequest
	 * @return ShopifyProduct
	 */
	...
	/**
	 * @param shopifyProductUpdateRequest
	 * @return ShopifyProduct
	 */
	...
	/**
	 * @param shopifyVariantUpdateRequest
	 * @return ShopifyVariant
	 */
	public ShopifyVariant updateVariant(final ShopifyVariantUpdateRequest shopifyVariantUpdateRequest) {
		...
		if (StringUtils.isNotBlank(shopifyVariantUpdateRequest.getImageSource())) {
			...
			final Response response = post(getWebTarget().path(PRODUCTS).path(productId).path(IMAGES), shopifyImageRootRequest);
	...
	/**
	 * @param shopifyRecurringApplicationChargeCreationRequest
	...
	public ShopifyRecurringApplicationCharge createRecurringApplicationCharge(
		...
		final ShopifyRecurringApplicationCharge shopifyRecurringApplicationChargeRequest =
				shopifyRecurringApplicationChargeCreationRequest.getRequest();
		shopifyRecurringApplicationChargeRootRequest.setRecurringApplicationCharge(shopifyRecurringApplicationChargeRequest);

		final Response response = post(getWebTarget().path(RECURRING_APPLICATION_CHARGES), shopifyRecurringApplicationChargeRootRequest);
		final ShopifyRecurringApplicationChargeRoot shopifyRecurringApplicationChargeRootResponse =
				response.readEntity(ShopifyRecurringApplicationChargeRoot.class);
	...
	public ShopifyRecurringApplicationCharge activateRecurringApplicationCharge(final String chargeId) {
		final ShopifyRecurringApplicationCharge shopifyRecurringApplicationChargeRequest = getRecurringApplicationCharge(chargeId);
		final Response response =
				post(getWebTarget().path(RECURRING_APPLICATION_CHARGES).path(chargeId).path(ACTIVATE), shopifyRecurringApplicationChargeRequest);
		final ShopifyRecurringApplicationChargeRoot shopifyRecurringApplicationChargeRootResponse =
				response.readEntity(ShopifyRecurringApplicationChargeRoot.class);
		return shopifyRecurringApplicationChargeRootResponse.getRecurringApplicationCharge();
	}
	...
	public ShopifyPage<ShopifyOrder> getOrders(final int pageSize) {
		final Response response =
				get(buildOrdersEndpoint().queryParam(STATUS_QUERY_PARAMETER, ANY_STATUSES).queryParam(LIMIT_QUERY_PARAMETER, pageSize));
	...
	/**
	 * @param minimumUpdatedAtDate
	 * @param maximumUpdatedAtDate
	 * @param maximumCreatedAtDate
	 * @param pageSize
	 * @return ShopifyPage<ShopifyOrder>
	 */
	...
	public ShopifyPage<ShopifyOrder> getOrders(final DateTime mininumCreationDate, final DateTime maximumCreationDate, final String appId,
		...
		final Response response = get(buildOrdersEndpoint().queryParam(STATUS_QUERY_PARAMETER, ANY_STATUSES)
				.queryParam(LIMIT_QUERY_PARAMETER, pageSize).queryParam(CREATED_AT_MIN_QUERY_PARAMETER, mininumCreationDate.toString())
				.queryParam(CREATED_AT_MAX_QUERY_PARAMETER, maximumCreationDate.toString()).queryParam(ATTRIBUTION_APP_ID_QUERY_PARAMETER, appId));
		return getOrders(response);
	}
	...
	public ShopifyPage<ShopifyOrder> getOrders(final String pageInfo, final int pageSize) {
		final Response response =
				get(buildOrdersEndpoint().queryParam(LIMIT_QUERY_PARAMETER, pageSize).queryParam(PAGE_INFO_QUERY_PARAMETER, pageInfo));
		return getOrders(response);
	}
	...
	/**
	 * @param shopifyOrderCreationRequest
	 * @return ShopifyOrder
	 */
	...
	/**
	 * @param shopifyOrderUpdateRequest
	 * @return ShopifyOrder
	 */
	...
	/**
	 * @param shopifyCustomerUpdateRequest
	...
	public ShopifyCustomer updateCustomer(final ShopifyCustomerUpdateRequest shopifyCustomerUpdateRequest) {
		...
		final Response response = put(getWebTarget().path(CUSTOMERS).path(shopifyCustomerUpdateRequest.getId()), shopifyCustomerUpdateRequestRoot);
	...
	/**
	 * @param shopifyGetCustomersRequest
	 * @return ShopifyPage<ShopifyCustomer>
	 */
	...
	public ShopifyPage<ShopifyCustomer> searchCustomers(final String query) {
		final Response response = get(getWebTarget().path(CUSTOMERS).path(SEARCH).queryParam(QUERY_QUERY_PARAMETER, query)
	...
	public ShopifyFulfillment cancelFulfillment(final String orderId, final String fulfillmentId) {
		...
		final Response response =
				post(buildOrdersEndpoint.path(orderId).path(FULFILLMENTS).path(fulfillmentId).path(CANCEL), new ShopifyFulfillment());
		final ShopifyFulfillmentRoot shopifyFulfillmentRootResponse = response.readEntity(ShopifyFulfillmentRoot.class);
		return shopifyFulfillmentRootResponse.getFulfillment();
	}
	...
	/**
	 * @param shopifyVariantMetafieldCreationRequest
	 * @return Metafield
	 */
	public Metafield createVariantMetafield(final ShopifyVariantMetafieldCreationRequest shopifyVariantMetafieldCreationRequest) {
		...
		final Response response =
				post(getWebTarget().path(VARIANTS).path(shopifyVariantMetafieldCreationRequest.getVariantId()).path(METAFIELDS), metafieldRoot);
	...
	/**
	 * @param shopifyProductMetafieldCreationRequest
	 * @return Metafield
	 */
	public Metafield createProductMetafield(final ShopifyProductMetafieldCreationRequest shopifyProductMetafieldCreationRequest) {
		...
		final Response response =
				post(getWebTarget().path(PRODUCTS).path(shopifyProductMetafieldCreationRequest.getProductId()).path(METAFIELDS), metafieldRoot);
		final MetafieldRoot metafieldRootResponse = response.readEntity(MetafieldRoot.class);
		return metafieldRootResponse.getMetafield();
	}
	 ...
	 */
	public ShopifyInventoryLevel updateInventoryLevel(final String inventoryItemId, final String locationId, final long quantity) {
		...
		final ShopifyInventoryLevelRoot shopifyInventoryLevelRootResponse = response.readEntity(ShopifyInventoryLevelRoot.class);
	...
	/**
	 * @param shopifyGiftCardCreationRequest
	...
	private ShopifyRefund calculateRefund(final ShopifyRefundCreationRequest shopifyRefundCreationRequest) {
		...
		final WebTarget path = buildOrdersEndpoint().path(shopifyRefundCreationRequest.getRequest().getOrderId()).path(REFUNDS).path(CALCULATE);
		final Response response = post(path, shopifyRefundRoot);
		final ShopifyRefundRoot shopifyRefundRootResponse = response.readEntity(ShopifyRefundRoot.class);
		return shopifyRefundRootResponse.getRefund();
	...
	/**
	 * @param shopifyProductRequest
	 * @param shopifyProduct
	 * @return ShopifyProduct
	 */
	private ShopifyProduct updateProductImages(final ShopifyProductRequest shopifyProductRequest, final ShopifyProduct shopifyProduct) {
	 ...
	 * @param shopifyProduct
	 */
	private void setVariantImageIds(final ShopifyProductRequest shopifyProductRequest, final ShopifyProduct shopifyProduct) {
	...
	public void createWebhook(final Webhook webhook) {
		log.debug("Creating webhook: {}", webhook.toString());

		final Response response = post(getWebTarget().path("webhooks.json"), webhook);
		log.debug("Webhook created: {}", response.toString());
	...
	private Response get(final WebTarget webTarget) {
		log.debug("get: calling: {}", webTarget.getUri().toString());
		final Callable<Response> responseCallable =
				() -> webTarget.request(MediaType.APPLICATION_JSON).header(ACCESS_TOKEN_HEADER, accessToken).get();
		final Response response = invokeResponseCallable(responseCallable);
		log.debug("get: response: {}", response.getEntity().toString());
	...
	private Response delete(final WebTarget webTarget) {
		final Callable<Response> responseCallable =
				() -> webTarget.request(MediaType.APPLICATION_JSON).header(ACCESS_TOKEN_HEADER, accessToken).delete();
		final Response response = invokeResponseCallable(responseCallable);
		return handleResponse(response, Status.OK);
	}
	...
	/**
	 * @return Retryer<Response>
	 */
	private Retryer<Response> buildResponseRetyer() {
		return RetryerBuilder.<Response>newBuilder().retryIfResult(ShopifyRestClient::shouldRetryResponse).retryIfException()
				.withWaitStrategy(WaitStrategies.randomWait(minimumRequestRetryRandomDelayMilliseconds, TimeUnit.MILLISECONDS,
						maximumRequestRetryRandomDelayMilliseconds, TimeUnit.MILLISECONDS))
				.withStopStrategy(StopStrategies.stopAfterDelay(maximumRequestRetryTimeoutMilliseconds, TimeUnit.MILLISECONDS))
	...
	private static boolean isServerError(final Response response) {
		return (Status.Family.SERVER_ERROR == Status.Family.familyOf(response.getStatus())) || (LOCKED_STATUS_CODE == response.getStatus());
	}
	...
	private String generateToken() {
		try {
			...
			final Response response = this.getUnversionedWebTarget().path(OAUTH).path(ACCESS_TOKEN).queryParam(CLIENT_ID, this.clientId)
					.queryParam(CLIENT_SECRET, this.clientSecret).queryParam(AUTHORIZATION_CODE, this.authorizationToken)
			...
			throw new ShopifyClientException(String.format(GENERAL_ACCESS_TOKEN_EXCEPTION_MESSAGE, shopSubdomain, this.authorizationToken), e);
		}
	}
	...
	private WebTarget getUnversionedWebTarget() {
		if (StringUtils.isNotBlank(this.shopSubdomain)) {
			return CLIENT.target(new StringBuilder().append(HTTPS).append(this.shopSubdomain).append(API_TARGET).toString());
		}
	...
	private WebTarget getWebTarget() {
		if (this.webTarget == null) {
			...
			log.info(SHOP_RETRIEVED_MESSAGE, shop.getId(), shop.getName());
		}
		return webTarget;
	}
	...
	public class ShopifySdkRetryListener implements RetryListener {
		...
		private static final String RETRY_EXCEPTION_ATTEMPT_MESSAGE =
				"An exception occurred while making an API call to shopify: {} on attempt number {} and {} seconds since first attempt";
		private static final String RETRY_INVALID_RESPONSE_ATTEMPT_MESSAGE =
				"Waited {} seconds since first retry attempt. This is attempt {}. Please review the following failed request information.\nRequest Location of {}\nResponse Status Code of {}\nResponse Headers of:\n{}\nResponse Body of:\n{}";
		...
		public <V> void onRetry(final Attempt<V> attempt) {
			if (attempt.hasResult()) {
				...
				if (log.isWarnEnabled() && !hasExceededRateLimit(response) && shouldRetryResponse(response)) {
					...
					final long delaySinceFirstAttemptInSeconds = convertMillisecondsToSeconds(attempt.getDelaySinceFirstAttempt());
					log.warn(RETRY_INVALID_RESPONSE_ATTEMPT_MESSAGE, delaySinceFirstAttemptInSeconds, attempt.getAttemptNumber(),
							response.getLocation(), response.getStatus(), response.getStringHeaders(), responseBody);
