...
public class ShopifyOrderShippingAddressUpdateRequest {
	...
	private static class Steps implements IdStep, Address1Step, Address2Step, CityStep, ProvinceStep, ProvinceCodeStep, ZipCodeStep, CountryStep,
			CountryCodeStep, PhoneStep, LatitudeStep, CompanyStep, LongitudeStep, LastNameStep, FirstNameStep, BuildStep {
		private String id;
