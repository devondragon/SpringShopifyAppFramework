...
public class ShopifyProductCreationRequest implements ShopifyProductRequest {
	...
	public static interface VariantCreationRequestsStep {
		public PublishedStep withVariantCreationRequests(final List<ShopifyVariantCreationRequest> variantCreationRequests);
	}
	...
	private ShopifyProductCreationRequest(final ShopifyProduct shopifyProduct, final Map<Integer, Integer> variantPositionToImagePosition) {
		this.request = shopifyProduct;
		this.variantPositionToImagePosition = variantPositionToImagePosition;
	}

	private static class Steps implements TitleStep, MetafieldsGlobalTitleTagStep, MetafieldsGlobalDescriptionTagStep, ProductTypeStep, BodyHtmlStep,
			VendorStep, TagsStep, SortedOptionNamesStep, ImageSourcesStep, VariantCreationRequestsStep, PublishedStep, BuildStep {
