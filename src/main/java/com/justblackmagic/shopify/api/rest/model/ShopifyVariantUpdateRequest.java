...
public class ShopifyVariantUpdateRequest implements ShopifyVariantRequest {
	...
	/**
	 * @return CurrentShopifyVariantStep
	 */
	...
	private ShopifyVariantUpdateRequest(final ShopifyVariant shopifyVariant, final String imageSource, final boolean changed) {
		this.request = shopifyVariant;
		this.imageSource = imageSource;
		this.changed = changed;
	}

	private static class Steps implements CurrentShopifyVariantStep, PriceStep, CompareAtPriceStep, SkuStep, BarcodeStep, WeightStep, AvailableStep,
			FirstOptionStep, SecondOptionStep, ThirdOptionStep, ImageSourceStep, InventoryManagementStep, InventoryPolicyStep, FulfillmentServiceStep,
			RequiresShippingStep, TaxableStep, InventoryItemIdStep, BuildStep {
		...
		public SkuStep withCompareAtPrice(final BigDecimal money) {
			if (shopifyVariant.getCompareAtPrice() == null || ZERO != money.compareTo(shopifyVariant.getCompareAtPrice())) {
